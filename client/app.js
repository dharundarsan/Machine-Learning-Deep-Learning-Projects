function getBathValue() {
  ...
  function onPageLoad() {
    ...
    var url = "http://127.0.0.1:5000/get_loc_name"; // Use this if you are NOT using nginx which is first 7 tutorials
    // var url = "/api/get_loc_name"; // Use this if  you are using nginx. i.e tutorial 8 and onwards
